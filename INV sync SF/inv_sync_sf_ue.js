...
define(['N/record', 'N/runtime', 'N/search', 'N/ui/serverWidget', 'N/format','N/https','./SF_GlobalUtilities.js'],
 function(record, runtime, search, serverWidget, format,https,SF) {
    ...
    function afterSubmit(context) {
        ...
        if (((context.type == "edit" || context.type == "create") && runtime.executionContext === runtime.ContextType.USER_INTERFACE)){        
            ...
            var sf_account_cus = rec.getValue('custbody_sf_account_cus');
            ...
            var data= { 'Obj' : {
                ...
                inv_id:rec.getValue('custbody_sf_id'),
            ...
            log.debug('data', data); 
            var response =JSON.parse(SF.posttoSF(data,'NS_INV_API'));
