 ...
 */
 define(['N/runtime', 'N/search', 'N/record','N/email','N/format','N/https','N/file', 'N/task','N/error','N/email']
 , function(runtime, search, record,email,format,https,file,task,error,email) {
     ...
     try {
        ...
        if(response.code=="200"){
           ...
           var fileObj = file.create({
              name: 'exchange_rate_'+format.format({value: new Date(), type: format.Type.DATETIMETZ, timezone: format.Timezone.ASIA_TAIPEI})+'.csv',
