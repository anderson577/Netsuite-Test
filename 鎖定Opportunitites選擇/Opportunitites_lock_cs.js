...
function(currentRecord, record, search, url, log) {
    ...
    function fieldChanged(context) {
        ...
        try{
            ...
            if(context.sublistId == "item" && context.fieldId == "custcol_customer_type"){
                if(objRecord.type=='purchaseorder'){
                    var customer_type=objRecord.getCurrentSublistValue({ sublistId: 'item', fieldId: 'custcol_customer_type' });
